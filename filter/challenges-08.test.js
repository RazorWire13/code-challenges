...
const filterStringsWithVowels = (input) => {
    // Solution code here...
    const vowelWords = input.filter( string => string.match(/[aeiou]/));
    return vowelWords;
  };
...
const getBaseStatGreaterThan = (input, minBaseStat) => {
  // Solution code here...
  return input.filter( value => value.baseStat > minBaseStat);
...
const getStatName = (input, minBaseStat) => {
  // Solution code here...
  return input.filter( value => value.baseStat > minBaseStat).map(filterValue => filterValue.stat.name);;
};
...
const getCharactersWithoutChildren = (input) => {
  // Solution code here...
  return input.filter ( value => !value.children);
};
...
const evenOddNumericValues = (input) => {
  // Solution code here...
  return input.filter ( value => !value.isInteger )
